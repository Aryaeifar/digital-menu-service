        ...
        <div class="my-10 w-75">
          <v-row>
            ...
            <v-col v-if="isActiveReserve">
              <v-btn
                :to="'/' + $route.params.restaurant_name + '/online-booking'"
                :color="icons_color || 'dark-l'"
                stacked
                class="rounded-lg"
                :width="80"
              ...
              >
                <img
                  src="@/assets/images/reserved2.svg"
                  alt=""
                  class="w-100"
                  height="25"
                />
            ...
            <v-col v-if="isActiveIdea">
              <v-btn
                :to="'/' + $route.params.restaurant_name + '/offers'"
                :color="icons_color || 'dark-l'"
                stacked
                class="rounded-lg"
                :width="80"
