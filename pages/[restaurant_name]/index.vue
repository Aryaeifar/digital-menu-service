...
const { getPremissions } = usePremission;
...
const items = ref([{ title: "FA" }, { title: "FR" }, { title: "EN" }])
...
onMounted(async () => {
  ...
  // isActiveReserve.value = !!reserveData.value?.data?.[route.params.restaurant_name]?.modules?.reserve
})
</script>
  ...
  <div class="landing-page h-screen" style="position: relative">
    <div style="position: fixed; bottom: 1%; right: 0%; left: 0">
      ...
      <div class="d-flex flex-column align-center text-center mt-5">
        ...
        <p class="main-description__color w-75 fw-regular">
          {{ short_subject }}
        </p>
        ...
        <div class="my-10 w-75">
          <v-row>
            <v-col>
              <v-btn :href="rightIconURL" :color="icons_color || 'dark-l'" stacked class="rounded-lg" :width="80"
                :height="80" flat="true">
            ...
            <v-col>
              <v-btn :href="middleIconURL" :color="icons_color || 'dark-l'" stacked class="rounded-lg" :width="80"
                :height="80" flat="true">
            ...
            <v-col>
              <v-btn :href="leftIconURL" :color="icons_color || 'dark-l'" stacked class="rounded-lg" :width="80"
                :height="80" flat="true">
            ...
            <v-col v-if="isActiveReserve">
              <v-btn :to="'/' + $route.params.restaurant_name + '/online-booking'" :color="icons_color || 'dark-l'"
                stacked class="rounded-lg" :width="80" :height="80" flat="true">
            ...
            <v-col v-if="isActiveIdea">
              <v-btn :to="'/' + $route.params.restaurant_name + '/offers'" :color="icons_color || 'dark-l'" stacked
                class="rounded-lg" :width="80" :height="80" flat="true">
